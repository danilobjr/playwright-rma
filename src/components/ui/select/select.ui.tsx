...
function Select({ ...otherProps }: SelectProps) {
  return <SelectPrimitive.Root data-slot="select" {...otherProps} />
}
...
function SelectValue({
  ...
  return <SelectPrimitive.Value data-slot="select-value" {...otherProps} />
}
...
function SelectItem({ children, className, ...otherProps }: SelectItemProps) {
  return (
